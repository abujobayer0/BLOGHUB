...
const Admin = () => {
    ...
    async function fetchArticles() {
      try {
        const response = await fetch(
          "https://blog-site-server-api-l5cu.onrender.com/articles"
        );
        if (response.ok) {
  ...
  const deleteArticle = async (id) => {
    try {
      const response = await fetch(
        `https://blog-site-server-api-l5cu.onrender.com/articles/${id}`,
        {
          method: "DELETE",
        }
      );
  ...
  const recentPost = articles.reverse();

  return (
    <>
      <Navbar />

      <section className="container px-4 mt-6 mx-auto">
                      ...
                      <tr>
                          ...
                          <div className="inline-flex items-center gap-x-3">
                            <div className="flex items-center gap-x-2">
                              <img
                                ...
                                src={`https://blog-site-server-api-l5cu.onrender.com/${item.image1}`}
                                alt=""
                              />
                              <div>
                        ...
                        <td className="px-4 py-4 text-sm whitespace-nowrap">
                          <div className="flex items-center gap-x-6">
                            ...
                            <Link to={`/articles/update/${item._id}`}>
